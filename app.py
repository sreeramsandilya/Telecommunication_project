...
pickle_in = open("C:\\Users\\ADMIN\\Model_Deployment_Chrun\\rf.pkl","rb")
rfcintel = pickle.load(pickle_in)
...
def Churn_data(account_length,voice_mail_plan,voice_mail_messages,day_mins,
    ...
    prediction = rfcintel.predict([[account_length,voice_mail_plan,voice_mail_messages,day_mins,evening_mins,night_mins,
